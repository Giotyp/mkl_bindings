...
pub const DFTI_1D_MEMORY_EXCEEDS_INT32: u32 = 9;
pub const DFTI_NO_WORKSPACE: u32 = 11;
...
pub const DFTI_CONFIG_PARAM_DFTI_FWD_DISTANCE: DFTI_CONFIG_PARAM = 58;
pub const DFTI_CONFIG_PARAM_DFTI_BWD_DISTANCE: DFTI_CONFIG_PARAM = 59;
pub type DFTI_CONFIG_PARAM = ::std::os::raw::c_uint;
...
extern "C" {
    #[doc = " INTERNAL INTERFACES. These internal interfaces are not intended to\n be called directly by oneMKL users and may change in future releases."]
    pub fn DftiCreateDescriptor_s_1d(
        arg1: *mut DFTI_DESCRIPTOR_HANDLE,
